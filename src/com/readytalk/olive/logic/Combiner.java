...
public class Combiner {
	public static String convertTo(String format, File video, File tempDir) throws IOException {
		String cmd = "ffmpeg -i ";
		if (isWindows()) {
			cmd = "cmd /c " + cmd;
		}
	...
	public static String combineVideos(String[] videoURLs, String[] videos, File tempDir)
	...
	public static int [] getBiggestDimensions(String [] videos, File tempDir) throws IOException{
	...
	public static int [] getDimensions(File video, File tempDir) throws IOException{
		Runtime r = Runtime.getRuntime();
	...
	public static String adjustDimensions(File video, int[]biggestDimensions, File tempDir) throws IOException {
