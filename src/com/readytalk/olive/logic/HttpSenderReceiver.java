...
public class HttpSenderReceiver {
	public static String sendReceive(String data, URL url) {
		...
		try {
			...
			System.err.println("Error communicating with URL: " + url.toString());
			e.printStackTrace();
		}
		return response;
	}
	...
	private static String getJson() {
		String data = "{\"api_key\": \""
				...
				+ "\",\"input\": \"https://s3.amazonaws.com/test-bucket-Olive/Wildlife.wmv\",\"output\": [{\"base_url\": \"https://s3.amazonaws.com/test-bucket-Olive/\",\"filename\": \"Wildlife0-3.wmv\",\"start_clip\": 6,\"clip_length\": 2}]}";
